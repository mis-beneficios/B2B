...
class SinSegmento implements FromView, ShouldAutoSize, WithColumnFormatting, WithProperties
{
    ...
    */
    ...
    {
        return view('exports.mx.sin_segmento', [
            'data' => $this->data,
        ]);
    }
    ...
    public function properties(): array
    {
        return [
            ...
            'title'          => 'Sin Segmentos',
            'description'    => 'Filtrado via serfin, folios sin segmentos',
