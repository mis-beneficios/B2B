                        ...
                        <div class="col-md-3">
                            ...
                            <select name="paise_id" id="paise_id" class="form-control select2 select2-hidden-accessible m-b-10" style="width: 100%">
                                ...
                                @foreach ($paises as $pais)
                                    <option value="{{ $pais->id }}" {{ ($pais->id == 1) ? 'selected' : '' }} > {{ $pais->title }}</option>
                                @endforeach
                            </select>
                            <h5 class="card-title mb-2 mt-2">
                                Convenio
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body table-responsive">
                <table class="table table-hover dataTable no-footer" id="tableTerminal" style="width: 100%; display: table; table-layout: auto;">
                    <thead>
                        <tr>
        ...
        $('body').on('submit', '#formUnlock', function(event) {
            ...
            $.ajax({
                ...
                success:function(res){
                    if (res.success == true) {
                        toastr['info']('Tarjetas desbloqueadas, los datos se mostraran hasta que se finalice la sesion');
