    ...
    <div class="modal-body" id="modal-body">
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input class="form-control" id="empresa" name="empresa" placeholder="Nombre de la empresa" type="text" value="{{ $concal->empresa }}">
                </input>
            ...
            <div class="form-group col-md-6">
                ...
                <input class="form-control" id="pagina_web" name="pagina_web" placeholder="Sitio web" type="text" value="{{ $concal->pagina_web }}">
                </input>
            ...
            <div class="form-group col-md-8">
                ...
                <input type="text" name="giro", id="giro" class="form-control" value="{{ $concal->giro }}">
            ...
            <div class="form-group col-md-4">
                ...
                <input class="form-control" id="no_empleados" name="no_empleados" placeholder="# Empleados" type="text" value="{{ $concal->no_empleados }}">
                </input>
            ...
            <div class="form-group col-md-4">
                ...
                <input class="form-control" id="estado" name="estado" placeholder="Estado" type="text" value="{{ $concal->estado }}">
                </input>
            ...
            <div class="form-group col-md-12">
                <textarea name="sucursal_lugar" id="sucursal_lugar"  class="form-control" rows="5">{{ $concal->sucursal_lugar }}</textarea>
            ...
            <div class="form-group col-md-12">
                ...
                <input type="text" name="estrategia" id="estrategia" class="form-control" value="{{ $concal->estrategia }}">
        ...
        <div class="form-row">
            <div class="form-group col-md-3">
                ...
                <input autocomplete="off" class="form-control" id="siguiente_llamada" name="siguiente_llamada" type="text" value="{{ $concal->siguiente_llamada }}">
                </input>
            ...
            <div class="form-group col-md-3">
                ...
                <input class="form-control" id="conmutador" name="conmutador" type="text" value="{{ $concal->conmutador }}">
                </input>
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                ...
                <input class="form-control" id="contacto" name="contacto" placeholder="Nombre del contacto" type="text" value="{{ $concal->contacto }}">
                </input>
            ...
            <div class="form-group col-md-4">
                ...
                <input class="form-control" id="puesto" name="puesto" placeholder="Puesto del contacto" type="text" value="{{ $concal->puesto_contacto }}">
                </input>
                <span class="text-danger error-puesto errors">
                </span>
            </div>
            <div class="form-group col-md-4">
                <label for="inputEmail4">
                ...
                <input class="form-control" id="telefonos" name="telefonos" placeholder="" type="text" value="{{ $concal->telefonos }}">
                </input>
            ...
            <div class="form-group col-md-4">
                ...
                <input class="form-control" id="email" name="email" placeholder="Correo electronico" type="text" value="{{ $concal->email }}">
                </input>
        ...
        <div class="row">
            <div class="form-group col-md-4">
                ...
                <input class="form-control" id="asistente" name="asistente" placeholder="Nombre email del asistente" type="text" value="{{ $concal->asistente }}">
                </input>
            ...
            <div class="form-group col-md-4">
                ...
                <input class="form-control" id="asistenten_telefono" name="asistenten_telefono" type="text" value="{{ $concal->asistenten_telefono }}">
                </input>
            ...
            <div class="form-group col-md-4">
                ...
                <input class="form-control" id="asistente_email" name="asistente_email" placeholder="" type="email" value="{{ $concal->asistente_email }}">
                </input>
            ...
            <div class="form-group col-md-12">
                ...
                <textarea class="form-control" id="observaciones" name="observaciones" rows="8" style="width:100%;">{{ $concal->observaciones }}</textarea>
                <span class="text-danger error-observaciones errors">
                </span>
            </div>
        </div>
    </div>
            ...
            Swal.fire({
                ...
                .then((result) => {
                    if (result.isConfirmed) {
                        Livewire.emit('crearConvenio', true);
                        Swal.fire(
                            '',
                        ...
                        Livewire.emit('crearConvenio', false);
                    }
                })
        }
    });
