            ...
            <div class="col-xl-9 col-lg-8 col-md">
                    ...
                    <div class="card-header">
                        <div class="card-actions">
                            ...
                            @if (Auth::user()->can('create', App\Tarjeta::class))
                                <button class="btn btn-info btn-xs" data-toggle="modal" data-user_id="{{ $user->id }}"
                                    id="btnAddTarjeta">
                                    <span>
                                        <i class="fas fa-plus">
                                        </i>
                ...
                @if (Auth::user()->can('viewAny', App\Reservacion::class))
                    <div class="card">
                        <div class="card-header">
                            <div class="card-actions">
                                @if (Auth::user()->role == 'reserver' || Auth::user()->role == 'admin')
                                    <button class="btn btn-info btn-xs" data-user_id="{{ $user->id }}"
                                        id="btnAddReservacion">
                                        <span>
                                            <i class="fas fa-plus">
                                            </i>
                                            Agregar reservación
                        ...
                        <div class="card-body collapse show">
                            <div class="table-responsive">
                                <table class="table table-hover" id="table_reservaciones"
