                                ...
                                <div class="row p-t-10">
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off" class="form-control" id="username" name="username"
                                                placeholder="ejemplo@mail.com" type="mail">
                                            <small class="form-control-feedback">
                                            </small>
                                            </input>
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6">
                                        <div class="form-group ">
                                            ...
                                            <input autocomplete="off" class="form-control form-control" id="password"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-4 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off" class="form-control datepicker"
                                                data-provide="datepicker" id="cumpleanos" name="cumpleanos"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input class="form-control" id="delegacion" name="delegacion"
                                            placeholder="Delegación" type="text" value="" />
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" cols="20" id="direccion" name="direccion" placeholder="Dirección"
                                                rows="4">
                                        </textarea>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" cols="20" id="direccion2" name="direccion2" placeholder="Información adicional"
                                                rows="4">
                                        </textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select
                                                ...
                                                id="como_se_entero" name="como_se_entero"
                                                style="width:100%; background-color: #fff;">
                                                <option value="">
                                                    Como se entero
                                                </option>
                                    ...
                                    <div class="col-md-3 mt-4 pt-2">
                                        <input checked="" class="ml-3" id="enviar_contrasena"
                                            name="enviar_contrasena" type="checkbox">
                ...
                $.ajax({
                        ...
                        success: function(res) {
                            if (res.success === true) {
                                ...
                                toastr['info']('Este registro pertenece al convenio: ' + res
