                ...
                <div class="form-row">
                    <div class="form-group col-lg-8 col-md-6">
                        ...
                        <select class="form-control" id="tarjeta_id" name="tarjeta_id">
                            ...
                            <option @if ($tarjeta->id == $contrato->tarjeta_id) selected="" @endif value="{{ $tarjeta->id }}">
                    ...
                    <div class="form-group col-lg-12 col-md-12">
                        ...
                        <input class="form-control" id="paquete" name="paquete" type="text" value="{{ $contrato->paquete }}"/>
                    </div>
                    <div class="form-group col-lg-4 col-md-6">
                        <label for="sys_key">
                            Clave VIA Serfin*
                        </label>
                        <input class="form-control" id="sys_key" name="sys_key" readonly="" value="{{ $contrato->sys_key }}"/>
                    </div>
                    <div class="form-group precio_de_compra col-lg-4 col-md-6">
                        <label for="precio_de_compra">
                            Precio de compra
                        </label>
                        <input class="form-control" id="precio_de_compra" name="precio_de_compra" value="{{ number_format($contrato->precio_de_compra,2,'.','') }}"/>
                    </div>
                    <div class="form-group col-lg-4 col-md-6">
                        <label for="divisa">
                            Divisa
                    ...
                    <div class="form-group col-lg-5 col-md-6">
                        ...
                        <input class="form-control" id="edad_max_ninos" name="edad_max_ninos" value="{{ $contrato->edad_max_ninos }}"/>
                    </div>
                    <div class="form-group col-lg-4 col-md-6 mt-4">
                        <div class="form-check">
                            <input class="form-check-input" id="pago_con_nomina" name="pago_nomina" type="checkbox" value="1">
                    ...
                    <div class="form-group col-lg-6 col-md-6 mt-4">
                       <label for="estatus">
                        ...
                        <select class="form-control" id="tipo_llamada" name="tipo_llamada" required="required" value="{{ $contrato->tipo_llamada }}">
                            <option value="">
                    ...
                    <div class="form-group col-lg-12 col-md-6">
                        ...
                        <select class="form-control" id="estatus" name="estatus" required="required" value="{{ $contrato->estatus }}">
                            <option value="">
                                Selecciona una opción
                            </option>
                    ...
                    <div class="form-group col-12" id="div_motivo_suspencion" style="display: none;">
                        ...
                        <select class="form-control" id="motivo_cancelacion" name="motivo_cancelacion">
                            ...
                            <option value="Penalización"  {{ ($contrato->motivo_estatus == "Penalización") ? 'selected' : ''}}>
                                Penalización
                            </option>
                            <option  value="Cancelacion por parte del cliente" {{ ($contrato->motivo_estatus == "Cancelacion por parte del cliente") ? 'selected' : '' }}>
