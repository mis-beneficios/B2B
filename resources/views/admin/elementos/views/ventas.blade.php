                            ...
                            <div class="form-row">
                                <div class="form-group col-md-8">
                                    ...
                                    <div class="input-group mb-3">
                                        <select
                                            class="form-control custom-select select2 m-b-10 select2-multiple select2-hidden-accessible"
                                            id="convenios_id" multiple="" name="convenio_id[]" style="width: 95%;">
                                        ...
                                        <div class="input-group-append">
                                            <button class="btn btn-sm btn-dark btnReloadConv" id="btnReloadConv"
                                                data-toggle="tooltip" data-placement="top"
                                                title="Recargar datos de convenios">
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <input autocomplete="false" class="form-control" id="fecha_inicio" name="fecha_inicio"
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <input autocomplete="false" class="form-control" id="fecha_fin" name="fecha_fin"
                                        type="text" value="{{ date('Y-m-d') }}" />
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-3">
                                    ...
                                    <select
                                        class="form-control custom-select select2 m-b-10 select2-multiple select2-hidden-accessible"
                                        id="estatus" multiple="" name="estatus[]" style="width:100%">
                                        <option value="">
                                            Todos
                                        </option>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select
                                        class="form-control custom-select select2 m-b-10 select2-multiple select2-hidden-accessible"
                                        id="tipo_llamada" multiple="" name="tipo_llamada[]" style="width:100%">
                                        <option value="VD">
                                            Venta Directa
                                        </option>
                                        <option value="en">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select
                                        class="form-control custom-select select2 m-b-10 select2-multiple select2-hidden-accessible"
                                        id="como_se_entero" multiple="" name="como_se_entero[]" style="width:100%">
                                        @php
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select
                                        class="form-control custom-select select2 m-b-10 select2-multiple select2-hidden-accessible"
                                        id="equipo" multiple="" name="equipo[]" style="width:100%">
        ...
        $(document).ready(function() {
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        $.each(res.convenios, function(index, val) {
                            $('#convenios_id').append('<option value="' + val.id +
                                '">' + val.empresa_nombre + '</option>');
                        });
                    }
                });
            });
            ...
            $('#export').on('click', function(event) {
                ...
                $.ajax({
                        ...
                        success: function(res) {
                            if (res.success == true) {
                                alertify.alert('Descargando...',
                                    'Descargando filtrado, no actualice ni cierre esta pestaña hasta que se descargue el archivo.'
                                );
