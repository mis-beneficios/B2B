    ...
    <body class="antialiased font-sans">
        <div class="md:flex min-h-screen">
            <div class="w-full md:w-1/2 bg-white flex items-center justify-center">
                <div class="max-w-sm m-8">
                    ...
                    <a href="{{  redirect()->back() }}">
                        {{--
                        <a href="{{ app('router')->has('inicio') ? route('inicio') : url('/') }}">
                            --}}
                            <a class="btn bg-transparent text-grey-darkest font-bold uppercase tracking-wide py-3 px-6 border-2 border-grey-light hover:border-grey rounded-lg" href="{{ url()->previous() }}">
                                {{ __('Volver...') }}
                            </a>
                        </a>
                        {{--
            ...
            <div class="relative pb-full md:flex md:pb-0 md:min-h-screen w-full md:w-1/2">
                {{-- @yield('image') --}}
                <img alt="" class="img-fluid" src="https://wallpaperaccess.com/full/424833.jpg">
                </img>
            </div>
        </div>
