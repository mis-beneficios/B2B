...
@section('content')
<section class="breadcrumb breadcrumb_bg" style="background-image:url({{ asset('images/eu/europa.jpg') }})">
    <div class="overlay_h">
    </div>
    <div class="container">
        <div class="row">
                ...
                <div class="breadcrumb_iner">
                    <div class="breadcrumb_iner_item text-center">
                        <p class="lead" style="font-size: 28px;">
                            Visit the Top 10 Destinations within the Europa.
                            <br/>
        ...
        <div class="row justify-content-center">
            <div class="col-xl-12">
                <div class="section_tittle text-center">
                    <h2>
                        Top 10 Destinations in the Europa
                    </h2>
                </div>
            </div>
        </div>
