                ...
                <div class="tab-pane active" id="home" role="tabpanel">
                    <div class="card-body">
                        <div class="profiletimeline">
                            <div class="sl-item">
                                <div class="sl-left">
                                    <img alt="user" class="img-circle" src="../assets/images/users/1.jpg">
                                    </img>
                                </div>
                                <div class="sl-right">
                                    <div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3 col-md-6 m-b-20">
                                                <img class="img-responsive radius" src="../assets/images/big/img1.jpg"/>
                                            </div>
                                            <div class="col-lg-3 col-md-6 m-b-20">
                                                <img class="img-responsive radius" src="../assets/images/big/img2.jpg"/>
                                            </div>
                                            <div class="col-lg-3 col-md-6 m-b-20">
                                                <img class="img-responsive radius" src="../assets/images/big/img3.jpg"/>
                                            </div>
                                            <div class="col-lg-3 col-md-6 m-b-20">
                                                <img class="img-responsive radius" src="../assets/images/big/img4.jpg"/>
                                            </div>
                                        </div>
                                        <div class="like-comm">
                                            <a class="link m-r-10" href="javascript:void(0)">
                                                2 comment
                                            </a>
                                            <a class="link m-r-10" href="javascript:void(0)">
                            ...
                            <hr>
                                <div class="sl-item">
                                    <div class="sl-left">
                                        <img alt="user" class="img-circle" src="../assets/images/users/2.jpg">
                                        </img>
                                    </div>
                                    <div class="sl-right">
                                        <div>
                                            ...
                                            <div class="m-t-20 row">
                                                <div class="col-md-3 col-xs-12">
                                                    <img alt="user" class="img-responsive radius" src="../assets/images/big/img1.jpg"/>
                                                </div>
                                ...
                                <hr>
                                    <div class="sl-item">
                                        <div class="sl-left">
                                            <img alt="user" class="img-circle" src="../assets/images/users/3.jpg">
                                            </img>
                                        </div>
                                        <div class="sl-right">
                                            <div>
                                    ...
                                    <hr>
                                        <div class="sl-item">
                                            <div class="sl-left">
                                                <img alt="user" class="img-circle" src="../assets/images/users/4.jpg">
                                                </img>
                                            </div>
                                            <div class="sl-right">
                                                <div>
                    ...
                    <div class="card-body">
                        ...
                        <hr>
                            ...
                            <hr>
                                ...
                                <div class="progress">
                                    <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="80" class="progress-bar bg-success" role="progressbar" style="width:80%; height:6px;">
                                        <span class="sr-only">
                                            50% Complete
                                        </span>
                                    </div>
                                ...
                                <div class="progress">
                                    <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="90" class="progress-bar bg-info" role="progressbar" style="width:90%; height:6px;">
                                        <span class="sr-only">
                                            50% Complete
                                        </span>
                                    </div>
                                ...
                                <div class="progress">
                                    <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="50" class="progress-bar bg-danger" role="progressbar" style="width:50%; height:6px;">
                                        <span class="sr-only">
                                            50% Complete
                                        </span>
                                    </div>
                                ...
                                <div class="progress">
                                    <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="70" class="progress-bar bg-warning" role="progressbar" style="width:70%; height:6px;">
                                        <span class="sr-only">
                                            50% Complete
                                        </span>
                                    </div>
