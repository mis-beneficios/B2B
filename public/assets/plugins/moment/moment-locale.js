...
(function(global, factory) {
    ...
    hooks.defineLocale('bn', {
        ...
        meridiemHour: function(hour, meridiem) {
            ...
            if (
                (meridiem === 'রাত' && hour >= 4) || (meridiem === 'দুপুর' && hour < 5) || meridiem === 'বিকাল') {
                return hour + 12;
            } else {
                return hour;
            }
    ...
    hooks.defineLocale('bo', {
        ...
        meridiemHour: function(hour, meridiem) {
            ...
            if (
                (meridiem === 'མཚན་མོ' && hour >= 4) || (meridiem === 'ཉིན་གུང' && hour < 5) || meridiem === 'དགོང་དག') {
                return hour + 12;
            } else {
                return hour;
            }
    ...
    hooks.defineLocale('ml', {
        ...
        meridiemHour: function(hour, meridiem) {
            ...
            if (
                (meridiem === 'രാത്രി' && hour >= 4) || meridiem === 'ഉച്ച കഴിഞ്ഞ്' || meridiem === 'വൈകുന്നേരം') {
                return hour + 12;
            } else {
                return hour;
            }
